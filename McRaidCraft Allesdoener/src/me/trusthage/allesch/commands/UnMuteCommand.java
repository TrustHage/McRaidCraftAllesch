					...
					if(target.getName() != sender.getName()){
						if(target != null){
							if(mute.contains(target.getName()) || loaded.contains(target.getName())){
								...
								sender.sendMessage(ChatColor.GOLD + "You've unmuted " + ChatColor.RED + target.getDisplayName());
								target.sendMessage(ChatColor.GOLD + "You have been unmuted by " + ChatColor.RED + "an admin.");	
						...
						sender.sendMessage(ChatColor.RED + "You can't unmute yourself");
					}
